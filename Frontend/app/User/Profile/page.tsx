        ...
        <div className="min-h-screen overflow-hidden bg-[linear-gradient(180deg,#1a0f0a_0%,#0e0704_40%,#0a0503_100%)]">
          ...
          <div className="z-10 mx-auto w-full max-w-2xl px-4 py-6 sm:px-6 sm:py-8 lg:max-w-3xl">
            ...
            <button
              ...
              className="cursor-pointer w-full mt-7 mb-10 flex items-center justify-center gap-2 rounded-xl py-3.5 font-bold text-sm text-[#e8563a] bg-[#e8563a]/10 border border-[#e8563a]/25"
            >
              <LogOut size={15} />
              Log out
            </button>
